...
export const profile = {
  ...
  decisionImProudOf:
    "I chose to work in a restaurnat while completing my summer internship to save money and practice time management.",
   ...
   */
  repoUrl: "https://github.com/kayleighdolan/my-site",
};
